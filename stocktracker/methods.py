...
import py_trading
from py_trading.live_trading import trending_stocks
from py_trading.download_tickers import load_biggest_movers
...
def get_trending_stocks():
	a = py_trading.Portfolio(load_biggest_movers()[:51])
	i = 0
	while True:
		if i % 10 == 0:
			a = py_trading.Portfolio(load_biggest_movers()[:51])
